...
== Лекция 1. Экосистема Java крупным планом
.	История платформы Java, распространенность языка Java, современные применения платформы и языка Java (desktop, server-side backend, mobile).
...
image::images/javasirs.jpg[width=300]
...
== Лекция 2. Структура Java-проекта. Базовый синтаксис. Unit-тесты

===	Структура Java-проекта

.	Maven-структура папок. Принцип Convention over Configuration
.	Модули (Maven & Java 9), мавен-координаты
...
===	Unit-тесты
 .	JUnit5. Место юнит-тестов в структуре Java-проекта
a.	Примеры запуска unit-тестов при сборке и в IDE
b.	Применение unit-тестов при разработке. Test-driven development

== Лекция 3. Классы и интерфейсы
 
=== Классы

image::images/thethreewords.jpg[width=340]
...
== Лекция 4. Исключения. Фундаментальные возможности стандартной библиотеки
...
=== Базовые возможности стандартной библиотеки

.	Строки
.. Пул строк. Конкатенация строк (Effective Java, 63). `String.format`. `StringBuilder`.
..	Регулярные выражения. Манипуляция со строками с помощью регулярных выражений. Преимущество использования регулярных выражений перед “наивными” манипуляциями со строками.
..	Экономия создания излишних объектов при манипуляциях со строками (Effective Java: 2.6)
.	Ввод-вывод. 
...
.	`ArrayList` и `HashMap`: пример создания и использования параметризованных классов.
...
==  Лекция 5. Generics (параметризованные классы), Lambdas & Method References
===	Generics
.	Необходимость создания параметризованных классов для более строгой типобезопасности
 
 
image::images/rtvscompiletime.png[width=350]
...
image::images/lambdas.png[width=350]

== Лекция 6. Коллекции и Streams API
...
== Лекция 7. Параллелизм

=== Введение. Работа с shared state
...
=== Atomics и неблокирующие алгоритмы
. Atomic-типы данных. 
...
== Лекция 8. Паттерны объектно-ориентированного проектирования
