= Core Java. Лекция 4: instanceof и Pattern Matching. Класс Object. Исключения. Строки
...
[source,java]
----
sealed interface Animal permits Dog, Cat { String vocalize(); }

final class Dog implements Animal {
    public String vocalize() { return "woof"; }
}
final class Cat implements Animal {
    public String vocalize() { return "meow"; }
}

static String whatDoesItSay(Animal a) {
    return a.vocalize();
    //VS
    return switch (a) {
        case Dog d -> "woof";
