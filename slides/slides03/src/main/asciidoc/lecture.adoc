...
digraph G {
  ...
  heap_date:name:e -> heap_string:w;
}
----
|===
...
* После Java25: пишем как угодно, главное в конструкторе субкласса не брать значения не проинстанцированных полей суперкласса.
